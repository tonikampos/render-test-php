-- #############################################################################
-- ## Esquema de Base de Datos para "GaliTroco"
-- ## Sistema de Intercambio de Habilidades/Servicios
-- ## Base de Datos: PostgreSQL
-- #############################################################################

-- ========= CREACIÓN DE LA BASE DE DATOS =========
-- NOTA: Si ya existe la base de datos, comenta estas líneas

-- Desconectar usuarios activos (solo si necesitas recrearla)
-- SELECT pg_terminate_backend(pg_stat_activity.pid)
-- FROM pg_stat_activity
-- WHERE pg_stat_activity.datname = 'galitrocodb' AND pid <> pg_backend_pid();

-- Eliminar si existe (CUIDADO: borra todos los datos)
...
COMMENT ON DATABASE galitrocodb IS 'Base de datos para el sistema GaliTroco - Intercambio de habilidades';

-- IMPORTANTE: Después de crear la BD, conéctate a ella y ejecuta el resto del script
-- En DBeaver: Click derecho en la conexión → Set Active Database → galitrocodb
